# Standalone dev / test / build flake for the goodnet-handler-dns
...
#
# goodnet-standalone-plugin: dns
{
  description = "GoodNet handler plugin: dns — standalone plugin flake.";
    ...
    in
    {
      ...
      devShells = forAllSystems (system: pkgs: {
        default = helpers.mkPluginDevShell pkgs {
          ...
          welcomeText = ''
  goodnet-handler-dns  —  standalone plugin dev shell
    ...
    nix run .#debug      — Debug build + gdb on test_dns
'';
        };
      });
